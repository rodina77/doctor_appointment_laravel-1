  ...
  <section class="text-center text-lg-start">
    ...
    <div class="container py-4">
      <div class="row g-0 align-items-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="card cascading-right" style="
            ...
            <div class="card-body p-5 shadow-5 text-center">
              <h2 class="fw-bold mb-5" style="text-shadow: 2px 4px 4px rgba(46,91,173,0.6);">Admin Login</h2>
              <form method="post" action="{{route('handleLoginAdmin')}}">
                @csrf
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          <img src="{{asset('img/admin.jpg')}}" class="w-100 rounded-4 shadow-4" style="height: 600px;" alt="" />
        </div>
      </div>
    </div>
    <!-- Jumbotron -->
